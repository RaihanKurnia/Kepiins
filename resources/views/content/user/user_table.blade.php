			...
			<div class="card card-custom gutter-b">
				<div class="card-header flex-wrap border-0 pt-6 pb-0">
					<div class="card-title">
						<h3 class="card-label">Master Data Table User
						<span class="d-block text-muted pt-2 font-size-sm">Data Table User</span></h3>
					</div>
					<div class="card-toolbar">
						...
						<!--end::Dropdown-->
						<!--begin::Button-->
						<a href="{{asset('/user/view_form')}}" class="btn btn-primary font-weight-bolder">
	    ...
	    columns: [
	        ...
	        { 
	          // btn ripple- btn-round btn-3d btn-success
                ...
                return "<a class='btn btn-icon btn-light-success btn-xs mr-2' href='{{asset('/user/view_form')}}?id="+data+"&view=1' id ="+data+">"+
					"<i class=' fas fa-eye'></i></a>"+"<a class='btn btn-icon btn-light-warning btn-xs mr-2'   href='{{asset('/user/view_form')}}?id="+data+"' id ="+data+">"+
