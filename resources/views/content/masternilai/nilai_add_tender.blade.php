        ...
        <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
            ...
            <div class="d-flex align-items-center flex-wrap mr-1">
                ...
                <div class="d-flex align-items-baseline mr-5">
                    <!--begin::Page Title-->
                    <h5 class="text-dark font-weight-bold my-2 mr-5">Nilai Tender</h5>
                    <!--end::Page Title-->
                    <!--begin::Breadcrumb-->
                    <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                        ...
                        <li class="breadcrumb-item">
                            <a href="" class="text-muted">Nilai Tender</a>
                        </li>
                        <li class="breadcrumb-item">
...
function add() {
    ...
    $.ajax({  
        ...
        // url : (!trigerUpdate?"{{ route('nilai_add_action_tender') }}":"#"),
        url :"{{ route('nilai_add_action_tender') }}",
        type : "POST",
        data: {
            "_token": "{{ csrf_token() }}",
            params : [
            ...
            if(result.success){
                Swal.fire({
                    ...
                    if (result.value || result.isDismissed) {
                        window.location.href = "{{ route('nilai_view_form_tender') }}"; 
                    }
                 }); 
        	} else{
                Swal.fire({
