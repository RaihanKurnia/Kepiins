        ...
        <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
            ...
            <div class="d-flex align-items-center flex-wrap mr-1">
                ...
                <div class="d-flex align-items-baseline mr-5">
                    <!--begin::Page Title-->
                    <h5 class="text-dark font-weight-bold my-2 mr-5">Nilai Rekomendasi</h5>
                    <!--end::Page Title-->
                    <!--begin::Breadcrumb-->
                    <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                        ...
                        <li class="breadcrumb-item">
                            <a href="" class="text-muted">Nilai Rekomendasi</a>
                        </li>
                        <li class="breadcrumb-item">
                ...
                <div class="card-body">
                    ...
                    <form class="form" id="kt_form">
                        <div class="row">
                            ...
                            <div class="col-xl-8">
                                <div class="my-5">
                                    <h3 class="text-dark font-weight-bold mb-10">Input <span style="color: white; background-color:#EB5353;">Nilai Rekomendasi</span> : </h3>
                                    <div class="form-group row">
                                        <label class="col-3">Minimum Nilai</label>
                                        <div class="col-9">
                                            <input class="form-control" type="number" id="minimum_rendah" placeholder='Input Nilai Rekomendasi' />
                                        </div>
                                    </div>
                                </div>
                            </div>
...
function preparedit(paramid) {
    ...
    success : function(result){
        ...
        if(!result.data[0]) {
            ...
            $('#minimum_rendah').val(result.data[0].nilai);
        }
...
function add() {
    ...
    $.ajax({  
        ...
        url :"{{ route('nilai_add_action_rekomen') }}",
        type : "POST",
        data: {
            "_token": "{{ csrf_token() }}",
            params : [
                {   
                    ...
                    maksimum : minimum_rendah,
                    nilai : minimum_rendah
                },
            ]
            },
        dataType : "json",
            ...
            if(result.success){
                Swal.fire({
                    ...
                    if (result.value || result.isDismissed) {
                        window.location.href = "{{ route('nilai_view_form_rekomen') }}"; 
                    }
                 }); 
        	} else{
                Swal.fire({
