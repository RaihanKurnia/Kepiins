    ...
    if (n) {
        var o = {
            ...
            l = {
                ...
                remove: function () {
                    !1 !== l.eventTrigger("beforeRemove") && (KTUtil.hasClass(i, "card-fullscreen") && KTUtil.hasClass(n, "card-fullscreen") && l.fullscreen("off"), l.removeTooltips(), KTUtil.remove(n), l.eventTrigger("afterRemove"))
                },
                ...
                setupTooltips: function () {
                    if (a.options.tooltips) {
                        var t = KTUtil.hasClass(n, "card-collapse") || KTUtil.hasClass(n, "card-collapsed"),
                            e = KTUtil.hasClass(i, "card-fullscreen") && KTUtil.hasClass(n, "card-fullscreen"),
                        ...
                        if (o) {
                            var l = e ? "bottom" : "top",
                                r = new Tooltip(o, {
                                    ...
                                    trigger: "hover",
                                    template: '<div class="tooltip tooltip-card tooltip bs-tooltip-' + l + '" role="tooltip">                            <div class="tooltip-arrow arrow"></div>                            <div class="tooltip-inner"></div>                        </div>'
                                });
                ...
                fullscreen: function (t) {
                    if ("off" === t || KTUtil.hasClass(i, "card-fullscreen") && KTUtil.hasClass(n, "card-fullscreen")) l.eventTrigger("beforeFullscreenOff"), KTUtil.removeClass(i, "card-fullscreen"), KTUtil.removeClass(n, "card-fullscreen"), l.removeTooltips(), l.setupTooltips(), a.footer && (KTUtil.css(a.body, "margin-bottom", ""), KTUtil.css(a.footer, "margin-top", "")), l.eventTrigger("afterFullscreenOff");
                    else {
                        if (l.eventTrigger("beforeFullscreenOn"), KTUtil.addClass(n, "card-fullscreen"), KTUtil.addClass(i, "card-fullscreen"), l.removeTooltips(), l.setupTooltips(), a.footer) {
                            var e = parseInt(KTUtil.css(a.footer, "height")),
                                o = parseInt(KTUtil.css(a.footer, "height")) + parseInt(KTUtil.css(a.header, "height"));
                            KTUtil.css(a.body, "margin-bottom", e + "px"), KTUtil.css(a.footer, "margin-top", "-" + o + "px")
                        }
        ...
        var l = {
            ...
            r = {
                ...
                showSubmenuDropdown: function (t) {
                    ...
                    KTUtil.addClass(t, "menu-item-hover"), t.getAttribute("data-menu-toggle-class") && KTUtil.addClass(o, t.getAttribute("data-menu-toggle-class"))
                },
    ...
    if (n) {
        var o = {
            ...
            l = {
                ...
                init: function (t) {
                    a.events = [], a.options = KTUtil.deepExtend({}, o, t), a.classBase = a.options.baseClass, a.classCustom = a.options.customClass, a.classShown = a.classBase + "-on", a.classOverlay = a.classBase + "-overlay", a.target, a.state = KTUtil.hasClass(n, a.classShown) ? "shown" : "hidden"
                },
                build: function () {
                ...
                show: function () {
                    "shown" != a.state && (l.eventTrigger("beforeShow"), l.toggleClass("show"), KTUtil.addClass(i, a.classShown), KTUtil.addClass(n, a.classShown), a.classCustom.length > 0 && KTUtil.addClass(i, a.classCustom), a.state = "shown", a.options.overlay && (a.overlay = KTUtil.insertAfter(document.createElement("DIV"), n), KTUtil.addClass(a.overlay, a.classOverlay), KTUtil.addEvent(a.overlay, "click", function (t) {
                        t.stopPropagation(), t.preventDefault(), l.hide(a.target)
                    })), l.eventTrigger("afterShow"))
                },
                hide: function () {
                    "hidden" != a.state && (l.eventTrigger("beforeHide"), l.toggleClass("hide"), KTUtil.removeClass(i, a.classShown), KTUtil.addClass(i, a.classPush), KTUtil.removeClass(n, a.classShown), a.classCustom.length > 0 && KTUtil.removeClass(i, a.classCustom), a.state = "hidden", a.options.overlay && a.overlay && KTUtil.remove(a.overlay), l.eventTrigger("afterHide"))
                },
...
var KTToggle = function (t, e) {
    ...
    if (n) {
        var i = {
            ...
            init: function (t) {
                a.element = n, a.events = [], a.options = t, a.target = KTUtil.getById(a.options.target), a.targetState = a.options.targetState, a.toggleState = a.options.toggleState, a.state = KTUtil.hasClasses(a.target, a.targetState) ? "on" : "off"
            },
            build: function () {
            ...
            toggleOn: function () {
                return i.eventTrigger("beforeOn"), KTUtil.addClass(a.target, a.targetState), a.toggleState && KTUtil.addClass(n, a.toggleState), a.state = "on", i.eventTrigger("afterOn"), i.eventTrigger("toggle"), a
            },
            toggleOff: function () {
                return i.eventTrigger("beforeOff"), KTUtil.removeClass(a.target, a.targetState), a.toggleState && KTUtil.removeClass(n, a.toggleState), a.state = "off", i.eventTrigger("afterOff"), i.eventTrigger("toggle"), a
            },
            eventTrigger: function (t) {
                for (var e = 0; e < a.events.length; e++) {
                    var n = a.events[e];
...
var KTUtil = function () {
    ...
    return {
        ...
        scrollInit: function (t, e) {
            function a() {
                var a, n;
                if (!1 !== (n = e.height instanceof Function ? e.height.call() : e.height))
                    if (n = parseInt(n), (e.mobileNativeScroll || e.disableForMobile) && KTUtil.isBreakpointDown("lg"))(a = KTUtil.data(t).get("ps")) ? (e.resetHeightOnDestroy ? KTUtil.css(t, "height", "auto") : (KTUtil.css(t, "overflow", "auto"), n > 0 && KTUtil.css(t, "height", n + "px")), a.destroy(), a = KTUtil.data(t).remove("ps")) : n > 0 && (KTUtil.css(t, "overflow", "auto"), KTUtil.css(t, "height", n + "px"));
                    else if (n > 0 && KTUtil.css(t, "height", n + "px"), e.desktopNativeScroll) KTUtil.css(t, "overflow", "auto");
                else {
                    "true" == KTUtil.attr(t, "data-window-scroll") && (e.windowScroll = !0), (a = KTUtil.data(t).get("ps")) ? a.update() : (KTUtil.css(t, "overflow", "hidden"), KTUtil.addClass(t, "scroll"), a = new PerfectScrollbar(t, {
                        wheelSpeed: .5,
                        swipeEasing: !0,
                    ...
                    sorting: function () {
                        var e = {
                            ...
                            sortClick: function (n) {
                                ...
                                if ((void 0 === d.sortable || !1 !== d.sortable) && (t(o.tableHead).find("th").removeClass("datatable-cell-sorted"), a.addClass(this, "datatable-cell-sorted"), t(o.tableHead).find(".datatable-cell > span > i").remove(), i.sortable)) {
                                    l.spinnerCallback(!0);
                                    var c = "desc";
    ...
    return {
        init: function (n) {
            e = KTUtil.getById(n), t = KTUtil.getBody(), e && ((a = new KTToggle(e, {
                ...
                }), KTLayoutStickyCard.update(), KTLayoutHeaderMenu.pauseDropdownHover(800), KTLayoutAsideMenu.pauseDropdownHover(800), KTCookie.setCookie("kt_aside_toggle_state", e.getState())
